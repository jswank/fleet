...
module "main" {
  source          = "../../../../terraform?ref=tf-mod-root-v1.1.0"
...
module "migrations" {
  source                   = "../../../../terraform/addons/migrations?ref=tf-mod-addon-migrations-v1.0.0"
...
module "mdm" {
  source             = "../../../../terraform/addons/mdm?ref=tf-mod-addon-mdm-v1.3.0"
...
module "firehose-logging" {
  source = "../../../../terraform/addons/logging-destination-firehose?ref=tf-mod-addon-logging-destination-firehose-v1.0.0"
...
module "osquery-carve" {
  source = "../../../../terraform/addons/osquery-carve?ref=tf-mod-addon-osquery-carve-v1.0.0"
...
module "monitoring" {
  source                      = "../../../../terraform/addons/monitoring?ref=tf-mod-addon-monitoring-v1.0.0"
...
module "logging_alb" {
  source        = "../../../../terraform/addons/logging-alb?ref=tf-mod-addon-logging-alb-v1.0.0"
  prefix        = local.customer
  enable_athena = true
}
...
module "ses" {
  source  = "../../../../terraform/addons/ses?ref=tf-mod-addon-ses-v1.0.0"
  zone_id = aws_route53_zone.main.zone_id
  domain  = "dogfood.fleetdm.com"
}

module "waf" {
  source = "../../../../terraform/addons/waf-alb?ref=tf-mod-addon-waf-alb-v1.0.0"
  name   = local.customer
  lb_arn = module.main.byo-vpc.byo-db.alb.lb_arn
}

# module "saml_auth_proxy" {
#   # source                       = "../../../../terraform/addons/saml-auth-proxy?ref=main"
